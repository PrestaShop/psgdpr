...
<div class="panel col-lg-10 right-panel">
    <h3>
        <i class="fa fa-wrench"></i> {l s='Configure your checkboxes' d='Modules.Psgdpr.ConsentCheckbox'} <small>{$module_display|escape:'htmlall':'UTF-8'}</small>
    </h3>
    <form method="post" action="{$moduleAdminLink|escape:'htmlall':'UTF-8'}&page=dataConsent" class="form-horizontal">
        <div>
            <p>{l s='Please customize your consent request messages in the dedicated fields below :' d='Modules.Psgdpr.ConsentCheckbox'}</p>
            <article class="alert alert-info" role="alert" data-alert="info">
                {l s='We recommend you to put a link to your confidentiality policy page in each of your custom messages. Be aware that a dedicated confidentiality policy page is required on your website; if you do not have one yet, please click' d='Modules.Psgdpr.ConsentCheckbox'} <a target="_blank" href="{$cmsConfPage|escape:'htmlall':'UTF-8'}">{l s='here' d='Modules.Psgdpr.ConsentCheckbox'}</a>.
            </article>
            <br><br>
            ...
            <div class="form-group">
                <div class="col-xs-12 col-sm-12 col-md-5 col-lg-3">
                    <div class="text-right">
                        <label class="boldtext control-label">{l s='Account creation form' d='Modules.Psgdpr.ConsentCheckbox'}</label>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7">
                    <span class="switch prestashop-switch fixed-width-lg">
                        ...
                        <label for="switch_account_creation_on" class="radioCheck">{l s='YES' d='Modules.Psgdpr.ConsentCheckbox'}</label>
                        ...
                        <label for="switch_account_creation_off" class="radioCheck">{l s='NO' d='Modules.Psgdpr.ConsentCheckbox'}</label>
                ...
                <div class="form-group">
                    <div class="col-xs-12 col-sm-12 col-md-5 col-lg-3">
                        <div class="text-right">
                            <label class="control-label">
                                {l s='Consent request message' d='Modules.Psgdpr.ConsentCheckbox'}
                            </label>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-7 col-lg-6">
                        ...
                        <div class="help-block">
                            <p>{l s='This message will be displayed on the customer creation form' d='Modules.Psgdpr.ConsentCheckbox'}</p>
                        </div>
                    </div>
                    {if $languages|count > 1}
            ...
            <div class="form-group">
                <div class="col-xs-12 col-sm-12 col-md-5 col-lg-3">
                    <div class="text-right">
                        <label class="boldtext control-label">{l s='Customer account area' d='Modules.Psgdpr.ConsentCheckbox'}</label>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7">
                    <span class="switch prestashop-switch fixed-width-lg">
                        ...
                        <label for="switch_account_customer_on" class="radioCheck">{l s='YES' d='Modules.Psgdpr.ConsentCheckbox'}</label>
                        ...
                        <label for="switch_account_customer_off" class="radioCheck">{l s='NO' d='Modules.Psgdpr.ConsentCheckbox'}</label>
                        <a class="slide-button btn"></a>
                    </span>
                </div>
            </div>
            ...
            {foreach from=$languages item=language}
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-7 col-lg-6">
                        ...
                        <div class="help-block">
                            <p>{l s='This message will be displayed in the My personal information tab in the customer account' d='Modules.Psgdpr.ConsentCheckbox'}</p>
                        </div>
                    </div>
                    {if $languages|count > 1}
                        <div class="col-xs-12 col-sm-12 col-md-7 col-lg-3">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7">
                    <span class="switch prestashop-switch fixed-width-lg">
                        ...
                        <label for="switch_registered_module_{$module.id_module|escape:'htmlall':'UTF-8'}_on" class="radioCheck">{l s='YES' d='Modules.Psgdpr.ConsentCheckbox'}</label>
                        ...
                        <label for="switch_registered_module_{$module.id_module|escape:'htmlall':'UTF-8'}_off" class="radioCheck">{l s='NO' d='Modules.Psgdpr.ConsentCheckbox'}</label>
                        <a class="slide-button btn"></a>
                    </span>
                </div>
            </div>
            ...
            {foreach from=$languages item=language}
                ...
                <div class="form-group">
                    <div class="col-xs-12 col-sm-12 col-md-5 col-lg-3">
                        <div class="text-right">
                            <label class="control-label">
                                <p>{l s='Consent request message' d='Modules.Psgdpr.ConsentCheckbox'}</p>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-7 col-lg-6">
                        ...
                        <div class="help-block">
                            <p>{l s='This message will be accomplanied by a checkbox' d='Modules.Psgdpr.ConsentCheckbox'}</p>
                        </div>
                    </div>
                    {if $languages|count > 1}
                        <div class="col-xs-12 col-sm-12 col-md-7 col-lg-3">
        ...
        <article class="alert alert-info" role="alert" data-alert="info">
            {l s='For other installed modules requiring consent confirmation, they will be displayed in this tab only if they have done the GDPR update. The corresponding fields will automatically appear in order for you to customize the consent confirmation checkboxes.' d='Modules.Psgdpr.ConsentCheckbox'}
        </article>
        <div class="panel-footer">
            <button type="submit" value="1" id="submitDataConsent" name="submitDataConsent" class="btn btn-default pull-right">
                <i class="process-icon-save"></i> {l s='Save' d='Modules.Psgdpr.ConsentCheckbox'}
            </button>
        </div>
    </form>
</div>
