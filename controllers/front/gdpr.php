...
class psgdprgdprModuleFrontController extends ModuleFrontController
{
    public function initContent()
    {
        ...
        $psVersion = (bool)version_compare(_PS_VERSION_, '1.7', '>=');
        ...
        $this->context->smarty->assign(
            array(
                ...
                'psgdpr_front_controller' => Context::getContext()->link->getModuleLink(
                    'psgdpr',
                    'gdpr',
                    $params,
                    true
                ),
                'psgdpr_csv_controller' => Context::getContext()->link->getModuleLink(
                    'psgdpr',
                    'ExportDataToCsv',
                    $params,
                    true
                ),
                'psgdpr_pdf_controller' => Context::getContext()->link->getModuleLink(
                    'psgdpr',
                    'ExportDataToPdf',
                    $params,
                    true
